...
Inductive bevalR: bexp -> bool -> Prop :=
  ...
  | E_BEq : forall (e1 e2: aexp) (n1 n2 : nat),
      (e1 \\ n1) -> (e2 \\ n2) -> bevalR (BEq e1 e2) (n1 =? n2)
...
Proof.
  ...
  - intros H; induction H; simpl;
    try (rewrite aeval_iff_aevalR in H, H0; simpl; rewrite H0, H);
    try rewrite (beq_nat_refl n); try rewrite leb_iff;
    try rewrite IHbevalR;
    try apply H1;
    try rewrite IHbevalR1, IHbevalR2;
    try reflexivity.
  - generalize dependent bv. generalize dependent b.
    ...
    + apply E_BAnd; try apply IHb1; try apply IHb2; reflexivity. Qed.
(** [] *)
